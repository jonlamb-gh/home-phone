// NOTE: most of this taken from https://github.com/AirborneEngineering/blethrs
// some from https://github.com/stm32-rs/stm32-eth

use cortex_m::peripheral::NVIC;
use nucleo_f767zi::hal::stm32f7x7::{self, Interrupt};
...
impl EthernetDevice {
    ...
    pub fn init(
        &mut self,
        rcc: &mut stm32f7x7::RCC,
        syscfg: &mut stm32f7x7::SYSCFG,
    ...
    pub fn interrupt_handler(&mut self) {
        Self::eth_interrupt_handler(&mut self.eth_dma);
    }

    pub fn eth_interrupt_handler(eth_dma: &mut stm32f7x7::ETHERNET_DMA) {
        eth_dma
            .dmasr
